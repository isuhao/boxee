...
bool CSettings::DeleteProfile(int index)
{
  ...
  if (CGUIDialogYesNo2::ShowAndGetInput(g_localizeStrings.Get(55690),message))
  {
    //delete profile
...
bool CSettings::SaveSources()
{
  ...
  refreshMenuMsg.SetStringParam("Update Sources");

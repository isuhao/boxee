...
CGUIDialogBoxeeOTAConfirmLocation::CGUIDialogBoxeeOTAConfirmLocation() :
   CGUIDialogBoxeeWizardBase(WINDOW_OTA_LOCATION_CONFIRMATION, "custom_boxee_livetv_setup_2a_3a.xml", "CGUIDialogBoxeeOTALocationConfirmation")
{
}
...
CGUIDialogBoxeeOTACountriesLocationConfiguration::CGUIDialogBoxeeOTACountriesLocationConfiguration() :
    CGUIDialogBoxeeWizardBase(WINDOW_OTA_COUNTRIES_CONFIGURATION, "custom_boxee_livetv_setup_3b.xml", "CGUIDialogBoxeeOTACountriesLocationConfiguration")
{
}
...
bool CGUIDialogBoxeeOTACountriesLocationConfiguration::GetCountriesFromServer()
{
  ...
  CStdString strUrl = BOXEE::BXConfiguration::GetInstance().GetURLParam("Boxee.ApiGetCountries", "http://app.boxee.tv/location/countries");
...
CGUIDialogBoxeeOTAZipcodeLocationConfiguration::CGUIDialogBoxeeOTAZipcodeLocationConfiguration() :
    CGUIDialogBoxeeWizardBase(WINDOW_OTA_ZIPCODE_CONFIGURATION, "custom_boxee_livetv_setup_2b_c.xml", "CGUIDialogBoxeeOTAZipcodeLocationConfiguration")
{

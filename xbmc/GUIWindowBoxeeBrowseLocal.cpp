...
void CLocalFilesSource::RequestItems(bool bUseCurPath)
{
  ...
  //don't do any sorting for these paths..
...
void CGUIWindowBoxeeBrowseLocal::UpdateSortButtonState()
{
  ...
  {
    ((CLocalBrowseWindowState*)m_windowState)->SetSort(CBoxeeSort(VIEW_SORT_METHOD_ATOZ, SORT_METHOD_LABEL, SORT_ORDER_ASC, g_localizeStrings.Get(53505), "start"));

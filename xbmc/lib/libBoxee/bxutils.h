...
public:
  ...
  static bool PerformJSONGetRequest(const std::string& url, Json::Value& response, int& returnCode);
  static Job_Result PerformJSONGetRequestInBG(const std::string& url, Json::Value& response, int& returnCode, bool silent=false);

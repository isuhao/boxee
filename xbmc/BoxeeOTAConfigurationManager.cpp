...
bool CBoxeeOTAConfigurationManager::RunWizard()
{
  m_isConnectedToFacebook = false;
  m_isConnectedToFacebook =g_application.GetBoxeeSocialUtilsManager().GetIsSocialUtilConnected(FACEBOOK_SERVICE_ID);
